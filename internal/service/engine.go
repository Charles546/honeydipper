...
func dispatchActivate(
	...
	payload := map[string]any{
		"agent":    dipper.InterpolateStr(activate.Agent, envData),
		"prompt":   dipper.InterpolateStr(activate.Prompt, envData),
		"provider": dipper.InterpolateStr(activate.Provider, envData),
		"event":    eventData,
		"ctx":      eventCtx,
		"workflow": workflowData,
	}
	if activate.Tools != nil {
		payload["tools"] = dipper.Interpolate(activate.Tools, envData)
	}
